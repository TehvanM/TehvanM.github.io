...
<h2 class="mb-4">Kontakt informatsioon</h2>
<div class="row">
<div class="col-md-6">
<h4>Võta meiega ühendust</h4>
<p>Meie meeskond on alati valmis sind aitama! Ära kõhkle meiega ühendust võtmast.</p>

<div class="contact-info">
<p><i class="bi bi-telephone"></i> <strong>Telefon:</strong> +372 5555 1234</p>
<p><i class="bi bi-envelope"></i> <strong>Email:</strong> info@e-pood.ee</p>
<p><i class="bi bi-geo-alt"></i> <strong>Aadress:</strong> Tallinn, Eesti</p>
...
echo '<div class="alert alert-success mt-3">Täname! Su sõnum on edukalt saadetud.</div>';
}
?>
</div>
</div>
