...
<div class="container mt-5">
    <div class="row">
        <div class="col-12">
            ...
            <p class="text-center text-muted">sirvi läbi tootevaliku ja leia endale sobivaid asju!</p>
        </div>
    </div>

    <div class="row">
        <?php
        // Kõikide toodete näitamine
    ...
    <?php if (isset($toodete_arv) && $toodete_arv > 0): ?>
        <div class="row mt-4">
            <div class="col-12 text-center">
                <p class="text-muted">Kokku leitud <?php echo $toodete_arv; ?> toodet</p>
            </div>
        </div>
    <?php endif; ?>
</div>
