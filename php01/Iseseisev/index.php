...
<a class="navbar-brand p-2 text-white fw-bold" href="#">E-Pood.ee</a>
...
<li class="nav-item">
<a class="nav-link text-white" href="index.php">Kodu</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link text-white" href="index.php?leht=midagi">Test leht</a>
</li>
...
<?php
// Suvaliselt valitud reklaamtekstid ja pildid
$reklaam_pildid = array("https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg", "https://images.pexels.com/photos/5625114/pexels-photo-5625114.jpeg", "https://images.pexels.com/photos/6347919/pexels-photo-6347919.jpeg");
$reklaam_tekstid = array("MEGA SUUR ALE<br>kuni -50% kõik tooted!", "BACK TO SCHOOL<br>-40% kooliasjad!", "SÜGISE ERIPAKKUMINE<br>-35% kõik!");
...
<p class="lead">Avasta meie suurepäraseid pakkumisi ja leida oma lemmiktooted soodsate hindadega!</p>
...
$lubatud_lehed = array('tooted', 'kontakt');
$on_lubatud = in_array($leht_nimi, $lubatud_lehed);

if ($on_lubatud == true) {
include($leht_nimi . '.php');
} else {
echo '<div class="container mt-5"><h1 class="text-center text-danger">404 - Sellist lehte ei eksisteeri!</h1></div>';
}
} else {
?>
...
<?php
// Toodete kuvamine CSV failist
$csv_fail = fopen("tooted.csv", "r");
if ($csv_fail) {
fgetcsv($csv_fail); // päise rida vahele
$toode_counter = 0;
while ($toote_andmed = fgetcsv($csv_fail)) {
if($toode_counter < 6) { // Max 6 toodet avalehel
echo "
...
<div class="col-md-6">
<p>&copy; 2024 Kõik õigused kaitstud</p>
<p>Kontakt: info@e-pood.ee</p>
</div>
</div>
</div>
</footer>
